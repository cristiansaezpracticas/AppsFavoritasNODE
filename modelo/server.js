...
class Server {
    ...
    rutas(){
    /******* RUTAS DE LA APP *****/ 
    this.app.get('/webresources/generic/apps/:id', async function (req, res) {
    ...
    this.app.get('/webresources/generic/apps', async function (req, res) {
    ...
    this.app.post('/webresources/generic/apps',function (req, res) {
        const body = req.body;
      ...
      //put-apps
      this.app.put('/webresources/generic/apps/:id',async function (req, res) {
        const body = req.body;
        const id = req.params.id;
      ...
      //delete APPS
      this.app.delete('/webresources/generic/apps/:id', async function (req, res) {
        const id = req.params.id;
